...
public class CameraUtil {
    ...
    public Size getPropSizeForHeight(List<Size> list, int minHeight) {
        ...
        tempWidth = list.get(list.size() - 1).width;
        List<Size> eqList = new ArrayList<>();
        for (Size size:list){
        ...
        Collections.sort(eqList, new CameraAscendSizeComparatorForHeight());
        return eqList.get(eqList.size()-1);
